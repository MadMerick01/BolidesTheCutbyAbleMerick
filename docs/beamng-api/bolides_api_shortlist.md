...
## AI driving / pursuit
- [ ] Verified in dump · [ ] Used in mod · [ ] Wrapped by compat helper — `ai.*` (TODO: list specific functions)

## UI / ImGui
- [ ] Verified in dump · [ ] Used in mod · [ ] Wrapped by compat helper — `ui_imgui` (TODO: list specific functions)

## Career / money
- [ ] Verified in dump · [ ] Used in mod · [ ] Wrapped by compat helper — `career_modules_playerAttributes.getAttributeValue(...)`
- [ ] Verified in dump · [ ] Used in mod · [ ] Wrapped by compat helper — `career_modules_playerAttributes.setAttributeValue(...)`
- [ ] Verified in dump · [ ] Used in mod · [ ] Wrapped by compat helper — `career_modules_playerAttributes.addAttributeValue(...)`
...
## Damage / impact
- [ ] Verified in dump · [ ] Used in mod · [ ] Wrapped by compat helper — `queueLuaCommand(...)` (TODO: confirm usage)

## Traffic / police / ambience
- [ ] Verified in dump · [ ] Used in mod · [ ] Wrapped by compat helper — `traffic` (TODO: list specific functions)

## Vehicle access / objects
- [ ] Verified in dump · [ ] Used in mod · [ ] Wrapped by compat helper — `be:getObjectByID(...)`
- [ ] Verified in dump · [ ] Used in mod · [ ] Wrapped by compat helper — `getObjById(...)`
