...
-- RobberBoss: manual spawn at ForwardKnownBreadcrumb(200m)
-- Behavior:
...
local ROBBER_MODEL = "bolide"
local ROBBER_CONFIG = "BolideBolide01"

local function log(msg)
  R.status = msg or ""
  if Host and Host.postLine then
    Host.postLine("RobberBoss", R.status)
  else
    print("[RobberBoss] " .. tostring(R.status))
  end
end
